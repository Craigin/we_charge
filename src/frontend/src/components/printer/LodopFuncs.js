...
console.log('===============run lodopfuncs');
//====判断是否需要安装CLodop云打印服务器:====
function needCLodop(){
    try{
	var ua=navigator.userAgent;
	console('============userAgent:',ua);
...
export function getLodop(oOBJECT,oEMBED){
    ...
    var strCLodopUpdate="<br><font color='#FF00FF'>CLodop云打印服务需升级!点击这里<a href='CLodop_Setup_for_Win32NT.zip'>执行升级</a>,升级后请刷新页面。</font>";
    var LODOP;
    try{
